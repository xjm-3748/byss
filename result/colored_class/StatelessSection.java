 ...
 */
  ...
  @Override public final void onBindLoadingViewHolder(  RecyclerView.ViewHolder holder){
    super.onBindLoadingViewHolder(holder);
  }
  @Override public final RecyclerView.ViewHolder getLoadingViewHolder(  $natural$View$$ $natural$view$$){
    return super.getLoadingViewHolder($natural$view$$);
  }
  @Override public final void onBindFailedViewHolder(  RecyclerView.ViewHolder holder){
    super.onBindFailedViewHolder(holder);
  }
  @Override public final RecyclerView.ViewHolder getFailedViewHolder(  $natural$View$$ $natural$view$$){
    return super.getFailedViewHolder($natural$view$$);
  }
}
