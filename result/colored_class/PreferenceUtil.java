...
import $natural$android$$.$natural$content$$.SharedPreferences;
import $natural$android$$.$natural$content$$.SharedPreferences.$natural$Editor$$;
import $natural$android$$.preference.PreferenceManager;
...
public final class PreferenceUtil {
  public static void reset(  final $natural$Context$$ context){
    SharedPreferences.$natural$Editor$$ edit=PreferenceManager.getDefaultSharedPreferences(context).edit();
    edit.clear();
    edit.apply();
  }
  ...
  private static void putFloat(  String key,  float value){
    ...
    $natural$Editor$$ editor=sharedPreferences.edit();
  ...
  public static void putStringProcess(  String key,  String value){
    SharedPreferences sharedPreferences=BilibiliApp.getInstance().getSharedPreferences("preference_mu",$natural$Context$$.MODE_MULTI_PROCESS);
    $natural$Editor$$ editor=sharedPreferences.edit();
