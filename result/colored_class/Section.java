package $natural$com$$.hotbitmapgg.bilibili.$natural$widget$$.sectioned;
 ...
 */
public RecyclerView.ViewHolder getHeaderViewHolder($natural$View$$ $natural$view$$){
return new SectionedRecyclerViewAdapter.EmptyViewHolder($natural$view$$);
}
/** 
 ...
 */
public RecyclerView.ViewHolder getFooterViewHolder($natural$View$$ $natural$view$$){
return new SectionedRecyclerViewAdapter.EmptyViewHolder($natural$view$$);
}
/** 
 ...
 */
public abstract RecyclerView.ViewHolder getItemViewHolder($natural$View$$ $natural$view$$);
/** 
 ...
 */
public RecyclerView.ViewHolder getLoadingViewHolder($natural$View$$ $natural$view$$){
return new SectionedRecyclerViewAdapter.EmptyViewHolder($natural$view$$);
}
/** 
 ...
 */
public RecyclerView.ViewHolder getFailedViewHolder($natural$View$$ $natural$view$$){
return new SectionedRecyclerViewAdapter.EmptyViewHolder($natural$view$$);
}
/** 
